...
describe('detectAnomalies — dwell นานผิดปกติ', () => {
  ...
  it('472 — พก vehicleId + เวลา (เปิดเที่ยววิ่ง)', () => {
    expect(anomalies[0]).toMatchObject({ vehicleId: 'V1', time: '2026-06-10 08:00:00' })
  })
...
describe('detectAnomalies — เวลาเดินทางช้าผิดปกติ', () => {
  ...
  it('จับ leg 45 นาที เป็น anomaly', () => {
    ...
    expect(a[0]).toMatchObject({ kind: 'travel', fromCustomerId: 'A', toCustomerId: 'B', value: 45, vehicleId: 'V1' })
  })
})
