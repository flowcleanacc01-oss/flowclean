    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#3DD8D8] text-[#1B3A5C] rounded-lg text-sm font-medium hover:bg-[#2bb8b8] transition-colors shadow-sm"
        >
    ...
    <Modal open onClose={onClose} title={initial ? 'แก้ไขรายจ่าย' : 'เพิ่มรายจ่าย'}>
      <div className="space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
          ...
          <button onClick={handleSave} className="px-6 py-2 bg-[#3DD8D8] text-[#1B3A5C] text-sm font-medium rounded-lg hover:bg-[#2bb8b8] transition-colors">
