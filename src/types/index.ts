...
// 455 — 'note' = หมายเหตุรายวันต่อ chip (ไม่กระทบ schedule · logic ทุกตัว ignore · อ่านเฉพาะตอน render chip)
export type ScheduleOverrideType = 'skip' | 'extra' | 'reschedule_skip' | 'reschedule_add' | 'note'
...
export const SCHEDULE_OVERRIDE_TYPE_CONFIG: Record<ScheduleOverrideType, { label: string; short: string; color: string }> = {
  ...
  note:               { label: 'หมายเหตุวันนี้', short: 'Note', color: 'slate' }, // 455 — annotation ไม่กระทบ schedule
}
